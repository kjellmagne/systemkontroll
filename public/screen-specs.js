...
export const mockRecords = {
  ...
  application: {
    ...
    fieldValues: {
      ...
      mfa_required: true,
      authentication_notes: "Innlogging skjer via organisasjonens identitetsplattform med MFA for administrative roller.",
      authorization_model: "Rollebasert (RBAC)",
      access_review_frequency: "Halvårlig",
      authorization_notes: "Tilganger styres via roller for HR, lønn og systemadministrasjon. Tilgangsrevisjon gjennomføres av systemeier.",
      backup_enabled: true,
      backup_frequency: "Daglig",
      last_restore_test_date: "2025-10-14",
      restore_responsible: "Driftspartner",
      backup_restore_notes: "Leverandør drifter sikkerhetskopiering og gjennomfører restore-test som del av årlig driftskontroll.",
      criticality: "Høy",
...
export const screenRegistry = [
  ...
  },
  {
    ...
    sectionLayouts: {
      ...
      authentication: { span: 12, icon: "security" },
      authorization: { span: 12, icon: "verified_user" },
      backup_restore: { span: 12, icon: "database" },
